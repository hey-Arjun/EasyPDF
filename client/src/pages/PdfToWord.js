...
const PdfToWord = () => {
  console.log('🎯 PdfToWord component loaded');
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      console.log('🌐 Making fetch request to /api/convert-from-pdf/pdf-to-word');
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/convert-from-pdf/pdf-to-word`, {
        method: 'POST',
        headers,
        body: formData
      });
    ...
    <div className="pdf-to-word-main">
      <div className="pdf-to-word-container">
        <div className="pdf-to-word-header">
          ...
          <p>Convert PDF documents to editable Word format (.docx)</p>
        </div>
        ...
        <div className="upload-section">
          <FileUpload
            ...
            multiple={false}
            title="Upload your PDF and convert it to Word"
        ...
        {result && (
          <div className="result-section">
            <div className="success-message">
              ...
              <p>Your PDF has been converted to Word successfully.</p>
              {result.jobId ? (
            ...
            <div className="file-info">
              ...
              <p><strong>Word file:</strong> {result.fileName}</p>
            </div>
